...
import { Bell, Heart, Share, ShoppingBag, User } from "lucide-react";
...
const RoomDetailPage = () => {
  ...
  const homestayId = "b5ed1988-b7fc-489f-beaa-c5bb064b1066"; // Replace with a valid ID from your database
  ...
  return (
    <>
      ...
      <section className="min-h-screen mx-auto  w-full px-40 bg-center bg-no-repeat bg-cover space-y-6 py-40">
            ...
            <div className="w-96 pl-2 space-y-4">
              ...
              <div className="w-full p-6 flex flex-col  rounded-xl shadow-md border">
                <div className="flex items-end gap-2 mb-4">
                  <p className="font-medium text-[21px] underline underline-offset-2">
